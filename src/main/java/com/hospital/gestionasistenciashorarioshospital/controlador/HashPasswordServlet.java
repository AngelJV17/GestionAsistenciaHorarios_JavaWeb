 ...
 * @author Angel
 */
@WebServlet(name = "HashPasswordServlet", urlPatterns = {"/HashPasswordServlet"})
public class HashPasswordServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet HashPasswordServlet</title>");
            out.println("</head>");
            out.println("<body>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h3>Contraseña:</h3>");
            out.println(password);

            out.println("<br><br>");

            out.println("<h3>Hash BCrypt:</h3>");
            out.println(hash);
